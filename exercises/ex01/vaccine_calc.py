...
percent_left: float = target - current_percentage  # calc & store % left to go, neg number if already exceeded target.
...
print("We will reach " + str(target) + "% vaccination in " + str(days_left) + 
     " days, which falls on " + completion_date.strftime("%B %d, %Y") + ".")
